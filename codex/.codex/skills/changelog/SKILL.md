...
1. **Detect `CHANGELOG.md`** in the current project root (`pwd`). If missing, ask: "No CHANGELOG.md found — create one? (yes / no)". If yes, copy the template from `~/.codex/skills/dev-setup/templates/CHANGELOG.md`. If no, stop.
...
#### Changed
- ♻️ AGENTS.md — replaced inline changelog rule with pointer to `/changelog` skill [\[e4f5a6b\]](https://github.com/user/repo/commit/e4f5a6b...full)
