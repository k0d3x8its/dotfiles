...
See `~/.codex/skills/tdd/tests.md` for examples.
...
See `~/.codex/skills/tdd/mocking.md` for mocking guidelines.
...
- Design interfaces for testability (see `~/.codex/skills/tdd/interface-design.md`)
- Identify opportunities for deep modules (see `~/.codex/skills/tdd/deep-modules.md`)
