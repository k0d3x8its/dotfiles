...
- **"Does this logic / state model feel right?"** → Read `~/.claude/skills/prototype/LOGIC.md`.
  Build a tiny interactive terminal app that pushes state through cases hard to reason
  about on paper.

- **"What should this look like?"** → Read `~/.claude/skills/prototype/UI.md`.
...
message, ADR (if it meets the three-condition gate in `~/.claude/references/code/CODE-REFERENCE.md`),
