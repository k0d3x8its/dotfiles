...
5. **Group commits by conventional-commit prefix** → sections with emoji prefix per entry:
   ...
   Write each entry as a meaningful prose description of what changed and why — not a raw dump of the commit subject. The commit subject is a seed; expand it into a reader-friendly explanation. Capitalise first letter. No trailing period. Append the commit hash as a standard markdown link at end of line:
